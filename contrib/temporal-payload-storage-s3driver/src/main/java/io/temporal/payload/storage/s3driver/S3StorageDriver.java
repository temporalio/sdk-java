...
public final class S3StorageDriver implements StorageDriver {
  ...
  private final @Nonnull S3StorageDriverClient client;
  private final @Nonnull BucketResolver bucketResolver;
  private final @Nonnull String name;
  private final int maxPayloadSize;

  private S3StorageDriver(
      @Nonnull S3StorageDriverClient client,
  ...
  /**
   * Renders {@link S3StorageDriverClient#describe()} as a {@code ", k=v"} suffix for failure
   * messages.
   */
  ...
  public static final class Builder {
    private S3StorageDriverClient client;
    ...
    public Builder setClient(@Nonnull S3StorageDriverClient client) {
      this.client = Objects.requireNonNull(client, "client");
      return this;
    }

    /**
     * Stores every payload in a fixed bucket. Convenience for a {@link BucketResolver} that always
     * returns {@code bucket}. The last of {@code setBucket}/{@code setBucketResolver} wins.
     */
    public Builder setBucket(@Nonnull String bucket) {
      Objects.requireNonNull(bucket, "bucket");
      this.bucketResolver = (context, payload) -> bucket;
      return this;
    }

    /**
     * Selects the bucket per payload. The last of {@code setBucket}/{@code setBucketResolver} wins.
     */
    ...
    /**
     * Maximum serialized payload size in bytes the driver accepts. Must be positive. Defaults to 50
     * MiB. Storing a larger payload fails the {@code store} call.
     */
    ...
    public S3StorageDriver build() {
      ...
      return new S3StorageDriver(client, bucketResolver, name, maxPayloadSize);
    }
  }
}
