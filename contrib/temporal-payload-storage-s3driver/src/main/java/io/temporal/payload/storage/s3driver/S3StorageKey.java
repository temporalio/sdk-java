...
final class S3StorageKey {
  ...
  // Percent-encode every key byte except letters, digits, and these. This is Python's
  // quote(safe="") scheme restricted to characters AWS documents as always-safe in S3 object keys.
  // Notably '~' is excluded (AWS lists it under "characters to avoid"), so it is escaped here even
  // though Python leaves it literal.
