 ...
 */
@Experimental
public final class CloudRunOpenTelemetryPlugin extends SimplePlugin {
  ...
  private CloudRunOpenTelemetryPlugin(Builder builder) {
    super(NAME);
  ...
  /** Builder for {@link CloudRunOpenTelemetryPlugin}. */
  public static final class Builder {
     ...
     * CloudRunOpenTelemetryPlugin#newFlushHook()} with the remaining shutdown time.
     */
    ...
    public CloudRunOpenTelemetryPlugin build() {
      return new CloudRunOpenTelemetryPlugin(this);
    }
  ...
  static String resolveServiceName(Map<String, String> env) {
    return OpenTelemetryWorker.resolveServiceName(
        env, DEFAULT_SERVICE_NAME, CLOUD_RUN_WORKER_POOL, K_SERVICE);
  }
}
