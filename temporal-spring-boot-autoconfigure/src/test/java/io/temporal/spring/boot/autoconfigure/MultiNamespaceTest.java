...
public class MultiNamespaceTest {
  ...
  public void shouldContainsNonRootRelatedBean() {
    Assertions.assertTrue(applicationContext.containsBean("ns1NamespaceFactory"));
    Assertions.assertTrue(applicationContext.containsBean("namespace2NamespaceFactory"));
