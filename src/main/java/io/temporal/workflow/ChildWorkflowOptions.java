...
public final class ChildWorkflowOptions {
  ...
  /**
   * Defines behaviour of the parent workflow when {@link CancellationScope} that wraps child
   * workflow execution request is cancelled. The result of the cancellation independently of the
