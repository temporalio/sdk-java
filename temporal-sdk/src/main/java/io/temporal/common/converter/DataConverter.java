 ...
 *
 * <p>{@link DataConverter} is expected to pass the {@link RawValue} payload through without conversion. Though
 * it should still apply the {@link PayloadCodec} to the {@link RawValue} payloads.
 */
