...
//    public static NexusClient newInstance(NexusClientOptions options);
    ...
    /**
     * Executes an operation on the Nexus service with the provided input.
     * This method is synchronous and returns the result directly.
     *
  ...
  <U, R> NexusClientHandle<R> start(BiFunction<T, U, R> operation, U input);
     ...
     */
  <U, R> NexusClientHandle<R> start(BiFunction<T, U, R> operation, U input, NexusOperationOptions options);
