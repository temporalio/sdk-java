...
public final class WorkflowInternal {
  ...
  public static int getVersion(String seriesId, String iterationId, int minSupported, int maxSupported) {
    assertNotReadOnly("get version");
      return getWorkflowOutboundInterceptor().getVersion(seriesId, iterationId, minSupported, maxSupported);
  }
