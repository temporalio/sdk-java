...
public class GetActivityResultOverLongPollWaitTest {
  ...
  public void testGetResult() {
    ...
    activityClient.start(SlowActivity.class, SlowActivity::run, slowOpts()).getResult();
  }

  @Test(timeout = 3 * LONG_POLL_TIMEOUT_SECONDS * 1000)
  public void testGetResultAsync() throws ExecutionException, InterruptedException {
    assumeTrue(SDKTestWorkflowRule.useExternalService);
    activityClient.start(SlowActivity.class, SlowActivity::run, slowOpts()).getResultAsync().get();
  }
}
