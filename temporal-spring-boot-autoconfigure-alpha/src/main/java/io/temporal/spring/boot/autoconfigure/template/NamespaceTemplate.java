...
public class NamespaceTemplate {
  ...
  public ClientTemplate getClientTemplate() {
    if (clientTemplate == null) {
      this.clientTemplate =
          new ClientTemplate(namespaceProperties, workflowServiceStubs, testWorkflowEnvironment);
    }
  ...
  public WorkersTemplate getWorkersTemplate() {
    if (workersTemplate == null) {
      this.workersTemplate =
          new WorkersTemplate(
              properties, namespaceProperties, workflowServiceStubs, testWorkflowEnvironment);
    }
