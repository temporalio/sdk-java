...
public class WorkflowReplayTest extends OpenTelemetryBaseTest {
   ...
   *    follow
   *       |
   *       l__-> RunWorkflow:TestWorkflow, (Error in workflow;                RunWorkflow:TestWorkflow
   *                        |              thread is dead; replay needed),               |
   *                      child                                                        child
   *                        v                                                            v
   *             StartActivity:Activity1 -follow> RunActivity:Activity1       StartActivity:Activity2 -follow> RunActivity:Activity2
   */
  @Test
  public void testWorkflowReplaySpanStructure() {
    ...
    // Find children of second workflow run - should only have activity2
    List<SpanData> workflowSecondRunChildren = spansHelper.getByParentSpan(workflowSecondRunSpan);
    assertEquals(1, workflowSecondRunChildren.size());
